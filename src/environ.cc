...
int WindowGeometry::save_window_size = 1;
int WindowGeometry::save_window_snap_size = 0;
int WindowGeometry::save_window_position = 1;
int WindowGeometry::restore_window_size;
int WindowGeometry::restore_window_position;

int
WindowGeometry::load_geometry (int cmdshow, POINT *point, SIZE *size)
{
